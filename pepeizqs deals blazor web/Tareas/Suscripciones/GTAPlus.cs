...
{
	public class GTAPlus : BackgroundService
	{
		private string id = APIs.GTAPlus.Suscripcion.Generar().Id.ToString().ToLower();

		private readonly ILogger<GTAPlus> _logger;
		private readonly IServiceScopeFactory _factoria;
		private readonly IDecompiladores _decompilador;
		private readonly IConfiguration _configuracion;

		public GTAPlus(ILogger<GTAPlus> logger, IServiceScopeFactory factory, IDecompiladores decompilador, IConfiguration configuracion)
		{
			_logger = logger;
			_factoria = factory;
