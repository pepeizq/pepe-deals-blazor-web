...
{
	public class Nexus : BackgroundService
	{
		private string id = APIs.Nexus.Tienda.Generar().Id;

		private readonly ILogger<Nexus> _logger;
		private readonly IServiceScopeFactory _factoria;
		private readonly IDecompiladores _decompilador;
		private readonly IConfiguration _configuracion;

		public Nexus(ILogger<Nexus> logger, IServiceScopeFactory factory, IDecompiladores decompilador, IConfiguration configuracion)
		{
			_logger = logger;
			_factoria = factory;
