...
{
	public class Noctre : BackgroundService
	{
		private string id = APIs.Noctre.Tienda.Generar().Id;

		private readonly ILogger<Noctre> _logger;
		private readonly IServiceScopeFactory _factoria;
		private readonly IDecompiladores _decompilador;
		private readonly IConfiguration _configuracion;

		public Noctre(ILogger<Noctre> logger, IServiceScopeFactory factory, IDecompiladores decompilador, IConfiguration configuracion)
		{
			_logger = logger;
			_factoria = factory;
